...
{
	if (region.ba.aw === region.bs.aw)
	{
		return 'on line ' + region.ba.aw;
	}
	return 'on lines ' + region.ba.aw + ' through ' + region.bs.aw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cb: 'hidden', b2: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cb: 'mozHidden', b2: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cb: 'msHidden', b2: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cb: 'webkitHidden', b2: 'webkitvisibilitychange' }
		: { cb: 'hidden', b2: 'visibilitychange' };
}
...
var author$project$CalcValue$CalcValue = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var elm$core$Basics$True = 0;
var author$project$CalcValue$wrap = F2(
	function (string, a) {
		return A3(author$project$CalcValue$CalcValue, string, a, true);
	});
...
var author$project$CalcValue$fromInt = function (_int) {
	var stringRep = elm$core$String$fromInt(_int);
	return A2(author$project$CalcValue$wrap, stringRep, _int);
};
var elm$core$Basics$mul = _Basics_mul;
var author$project$Main$init = {
	ar: author$project$CalcValue$fromInt((50 * 1000) * 1000),
	aA: author$project$CalcValue$fromInt(50),
	aX: author$project$CalcValue$fromInt(65535)
};
var elm$core$Basics$False = 1;
var author$project$CalcValue$setStringFailedConv = F2(
	function (string, _n0) {
		var a = _n0.b;
		return A3(author$project$CalcValue$CalcValue, string, a, false);
	});
...
var author$project$CalcValue$updateIntFromStr = F2(
	function (string, intCalcValue) {
		return A2(
			elm$core$Maybe$withDefault,
			A2(author$project$CalcValue$setStringFailedConv, string, intCalcValue),
			A2(
				elm$core$Maybe$map,
				function (_int) {
					return A3(author$project$CalcValue$CalcValue, string, _int, true);
				},
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_update(
					model,
					{
						ar: A2(author$project$CalcValue$updateIntFromStr, string, model.ar)
					});
			case 1:
				var string = msg.a;
				return _Utils_update(
					model,
					{
						aA: A2(author$project$CalcValue$updateIntFromStr, string, model.aA)
					});
			default:
				var string = msg.a;
				return _Utils_update(
					model,
					{
						aX: A2(author$project$CalcValue$updateIntFromStr, string, model.aX)
					});
		}
	});
var author$project$Main$UpdateBandwidth = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$UpdateRtt = function (a) {
	return {$: 1, a: a};
};
...
var rtfeldman$elm_css$Css$solid = {m: 0, O: 0, v: 'solid'};
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bp: elm$core$Maybe$Nothing, bx: _List_Nil, bE: _List_Nil, bS: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	...
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bp: charset, b6: declarations, bx: imports, bE: namespaces};
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return elm$core$String$isEmpty(record.b5) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3(elm$core$Dict$insert, record.ci, record.b5, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bp: charset, b6: finalDeclarations, bx: imports, bE: namespaces};
};
...
var author$project$Main$errorBorder = function (isErr) {
	return isErr ? rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				A3(
...
var cuducos$elm_format_number$FormatNumber$Locales$Locale = F7(
	function (decimals, thousandSeparator, decimalSeparator, negativePrefix, negativeSuffix, positivePrefix, positiveSuffix) {
		return {b3: decimalSeparator, b4: decimals, cj: negativePrefix, ck: negativeSuffix, cp: positivePrefix, cq: positiveSuffix, cv: thousandSeparator};
	});
...
var erosson$number_suffix$NumberSuffix$suffixEngineering = function (digits) {
	return (digits <= 3) ? '' : ('E' + elm$core$String$fromInt(((digits / 3) | 0) * 3));
};
var erosson$number_suffix$NumberSuffix$getListSuffix = F2(
	function (suffixes, digits) {
		var _n0 = A2(elm$core$Array$get, (digits / 3) | 0, suffixes);
		if (!_n0.$) {
			var s = _n0.a;
			return s;
		} else {
			return erosson$number_suffix$NumberSuffix$suffixEngineering(digits);
		}
	});
...
var erosson$number_suffix$NumberSuffixData$standard = elm$core$Array$fromList(
	_List_fromArray(
...
var erosson$number_suffix$NumberSuffix$suffixStandard = erosson$number_suffix$NumberSuffix$getListSuffix(erosson$number_suffix$NumberSuffixData$standard);
var erosson$number_suffix$NumberSuffix$standardConfig = {
	ca: erosson$number_suffix$NumberSuffix$suffixStandard,
	a2: _Utils_update(
...
var erosson$number_suffix$NumberSuffixData$standardShort = elm$core$Array$fromList(
	_List_fromArray(
		['', 'K', 'M', 'B', 'T', 'Qa', 'Qi', 'Sx', 'Sp', 'Oc', 'No', 'Dc', 'UDc', 'DDc', 'TDc', 'QaDc', 'QiDc', 'SxDc', 'SpDc', 'ODc', 'NDc', 'Vi', 'UVi', 'DVi', 'TVi', 'QaVi', 'QiVi', 'SxVi', 'SpVi', 'OVi', 'NVi', 'Tg', 'UTg', 'DTg', 'TTg', 'QaTg', 'QiTg', 'SxTg', 'SpTg', 'OTg', 'NTg', 'Qd', 'UQd', 'DQd', 'TQd', 'QaQd', 'QiQd', 'SxQd', 'SpQd', 'OQd', 'NQd', 'Qq', 'UQq', 'DQq', 'TQq', 'QaQq', 'QiQq', 'SxQq', 'SpQq', 'OQq', 'NQq', 'Sg', 'USg', 'DSg', 'TSg', 'QaSg', 'QiSg', 'SxSg', 'SpSg', 'OSg', 'NSg', 'St', 'USt', 'DSt', 'TSt', 'QaSt', 'QiSt', 'SxSt', 'SpSt', 'OSt', 'NSt', 'Og', 'UOg', 'DOg', 'TOg', 'QaOg', 'QiOg', 'SxOg', 'SpOg', 'OOg', 'NOg']));
var erosson$number_suffix$NumberSuffix$suffixStandardShort = erosson$number_suffix$NumberSuffix$getListSuffix(erosson$number_suffix$NumberSuffixData$standardShort);
var author$project$Main$fmtConfig = function (a) {
	return _Utils_update(
		a,
		{
			ca: A2(
				elm$core$Basics$composeR,
				erosson$number_suffix$NumberSuffix$suffixStandardShort,
				function (s) {
					return '  ' + s;
				}),
			ch: 1000
		});
}(erosson$number_suffix$NumberSuffix$standardConfig);
var elm$core$Basics$pow = _Basics_pow;
var elm$core$Basics$abs = function (n) {
	return (n < 0) ? (-n) : n;
};
var elm$core$Basics$round = _Basics_round;
var erosson$number_suffix$NumberSuffix$roundTo = F3(
	function (rounder, roundExp, val) {
		var roundConst = A2(elm$core$Basics$pow, 10, roundExp);
		return rounder(val * roundConst) / roundConst;
	});
var erosson$number_suffix$NumberSuffix$countDigits = A2(
	elm$core$Basics$composeR,
	elm$core$Basics$abs,
	A2(
		elm$core$Basics$composeR,
		...
		A2(
			elm$core$Basics$composeR,
			A2(erosson$number_suffix$NumberSuffix$roundTo, elm$core$Basics$round, 9),
			A2(
				elm$core$Basics$composeR,
...
var erosson$number_suffix$NumberSuffix$dropIntDecimals = function (val) {
	var _n0 = A2(elm$core$String$split, '.', val);
	if (_n0.b && _n0.b.b) {
		var head = _n0.a;
		var _n1 = _n0.b;
		var tail = _n1.a;
...
var cuducos$elm_format_number$Parser$FormattedNumber = F5(
	function (original, integers, decimals, prefix, suffix) {
		return {b4: decimals, bA: integers, bG: original, a7: prefix, bc: suffix};
	});
	...
	var onlyZeros = A2(
		...
		elm$core$String$concat(
			A2(
				elm$core$List$append,
				formatted.bA,
				elm$core$List$singleton(formatted.b4))));
	return onlyZeros ? 1 : ((formatted.bG < 0) ? 2 : 0);
};
...
var cuducos$elm_format_number$Parser$parse = F2(
	function (locale, original) {
		var parts = A2(
			elm$core$String$split,
			'.',
			A2(myrho$elm_round$Round$round, locale.b4, original));
		...
		switch (_n0) {
			case 2:
				return _Utils_update(
					partial,
					{a7: locale.cj, bc: locale.ck});
			case 0:
				return _Utils_update(
					partial,
					{a7: locale.cp, bc: locale.cq});
			default:
				return partial;
		}
	});
var cuducos$elm_format_number$Stringfy$formatDecimals = F2(
	function (locale, decimals) {
		return (decimals === '') ? '' : _Utils_ap(locale.b3, decimals);
	});
...
var cuducos$elm_format_number$Stringfy$humanizeDecimals = F3(
	function (locale, strategy, decimals) {
		if ((decimals === '') || _Utils_eq(
			A2(elm$core$String$repeat, locale.b4, '0'),
			decimals)) {
			return '';
		} else {
			if (!strategy) {
				return _Utils_ap(locale.b3, decimals);
			} else {
				return A2(
...
var cuducos$elm_format_number$Stringfy$stringfy = F3(
	function (locale, strategy, formatted) {
		...
		var integers = A2(elm$core$String$join, locale.cv, formatted.bA);
		var decimals = stringfyDecimals(formatted.b4);
		return elm$core$String$concat(
			_List_fromArray(
				[formatted.a7, integers, decimals, formatted.bc]));
	});
...
var erosson$number_suffix$NumberSuffix$formatLocaleSigfigs = F3(
	function (locale, sigfigs, val) {
		var decimals = A2(
			elm$core$Basics$max,
			0,
			sigfigs - erosson$number_suffix$NumberSuffix$countDigits(val));
		return A2(
			cuducos$elm_format_number$FormatNumber$format,
			_Utils_update(
				locale,
				{b4: decimals}),
			A3(erosson$number_suffix$NumberSuffix$roundTo, elm$core$Basics$truncate, decimals, val));
	});
var erosson$number_suffix$NumberSuffix$formatSigExp = F3(
	function (_n0, sig0, exp) {
		var getSuffix = _n0.ca;
		var sigfigs = _n0.a9;
		var locale = _n0.a2;
		var suffixDivisor = _n0.aU;
		var minSuffix = _n0.ch;
		var sig = sig0 * A2(
			elm$core$Basics$pow,
			10,
			elm$core$Basics$abs(exp) % suffixDivisor);
		var n = sig0 * A2(elm$core$Basics$pow, 10, exp);
		var formatLocale = A2(erosson$number_suffix$NumberSuffix$formatLocaleSigfigs, locale, sigfigs);
		return (_Utils_cmp(
			elm$core$Basics$abs(n),
			minSuffix) < 0) ? erosson$number_suffix$NumberSuffix$dropIntDecimals(
			formatLocale(n)) : _Utils_ap(
			formatLocale(sig),
			getSuffix(exp));
	});
var erosson$number_suffix$NumberSuffix$format = F2(
	function (config, n) {
		var exp = erosson$number_suffix$NumberSuffix$countDigits(n) - 1;
		var sig = n / A2(elm$core$Basics$pow, 10, exp);
		return A3(erosson$number_suffix$NumberSuffix$formatSigExp, config, sig, exp);
	});
var erosson$number_suffix$NumberSuffix$formatInt = function (config) {
	return A2(
		elm$core$Basics$composeR,
		elm$core$Basics$toFloat,
		erosson$number_suffix$NumberSuffix$format(config));
};
...
var author$project$Main$view = function (model) {
	...
	var rttStr = _n0.a;
	var rttVal = _n0.b;
	var rttConverted = _n0.c;
	var _n1 = model.ar;
	var bwStr = _n1.a;
	var bwVal = _n1.b;
	var bwConverted = _n1.c;
	var reqWindow = ((((bwVal * rttVal) / 1000) | 0) / 8) | 0;
	return A2(
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$for('bwInput')
									]),
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text('Bandwidth (bits/s)')
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$td,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$id('bwInput'),
										rtfeldman$elm_css$Html$Styled$Attributes$type_('string'),
										rtfeldman$elm_css$Html$Styled$Attributes$value(bwStr),
										rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$UpdateBandwidth),
										author$project$Main$errorBorder(!bwConverted)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								A2(erosson$number_suffix$NumberSuffix$formatInt, author$project$Main$fmtConfig, bwVal) + 'bit/s')
							]))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$tr,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$for('rttInput')
									]),
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text('RTT (ms)')
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$td,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$id('rttInput'),
										rtfeldman$elm_css$Html$Styled$Attributes$type_('string'),
										rtfeldman$elm_css$Html$Styled$Attributes$value(rttStr),
										rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$UpdateRtt),
										author$project$Main$errorBorder(!rttConverted)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(
								elm$core$String$fromInt(rttVal) + ' ms')
							]))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$tr,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Required window')
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$td,
						_List_fromArray(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(
								elm$core$String$fromInt(reqWindow) + ' bytes')
							]))
					]))
			]));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bv: fragment, bw: host, bH: path, bJ: port_, bM: protocol, bN: query};
	});
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{
		...
		cA: A2(elm$core$Basics$composeR, author$project$Main$view, rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
